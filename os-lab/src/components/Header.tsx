            ...
            <div className="max-w-screen-xl mx-auto px-6 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="font-display text-sm font-bold gradient-text tracking-wider">OS LAB</h1>
                ...
                <div className="flex items-center gap-3">
                    {comparisonMode && (
                        <motion.div
                            ...
                            className="hidden sm:flex items-center gap-1.5 text-[10px] font-mono px-2.5 py-1 rounded-lg border bg-gradient-to-r from-blue-500/10 to-green-500/10 border-[rgba(63,185,80,0.25)] text-green-300"
                        >
                            <GitCompare size={10} />
                            FCFS vs SSTF
                        </motion.div>
